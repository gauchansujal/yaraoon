...
bus_button=Button(button_label,text="Tourist travels ", bg='#002447', fg="black",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0, activebackground="#002447")
bus_button.pack(side=LEFT,padx=(35,0),pady=1)

bus2_button=Button(button_label,text="6:30 PM", bg='#002447', fg="black",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0, activebackground="#002447")
bus2_button.pack(side=LEFT,padx=0,pady=8)

bus3_button=Button(button_label,text="rs:650", bg='#002447', fg="black",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0, activebackground="#002447")
...
bus4_button=Button(second_button,text="Legend Gorkha ", bg='#002447', fg="black",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0, activebackground="#002447")
bus4_button.pack(side=LEFT,padx=(35,0),pady=8)

bus5_button=Button(second_button,text="4:00 PM", bg='#002447', fg="black",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0, activebackground="#002447")
bus5_button.pack(side=LEFT,padx=0,pady=8)

bus6_button=Button(second_button,text="rs:7500", bg='#002447', fg="black",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0, activebackground="#002447")
...
bus7_button=Button(third_button,text="Nepal travels ", bg='#002447', fg="black",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0, activebackground="#002447")
bus7_button.pack(side=LEFT,padx=(35,0),pady=8)

bus8_button=Button(third_button,text="12:30 PM", bg='#002447', fg="black",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0, activebackground="#002447")
bus8_button.pack(side=LEFT,padx=0,pady=8)

bus9_button=Button(third_button,text="rs.700", bg='#002447', fg="black",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0, activebackground="#002447")
