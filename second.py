...
def choose(text,button):
    result=messagebox.askokcancel("",f"Are you sure you want to choose this bus {text}")
    if result:
        print("User clicked OK")
        root.destroy()
        import bus
...
bus3_button=Label(button_label,text="rs:1500", bg='#002447', fg="white",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0)
...
bus_button=Button(button_label,text="Tourist travels ", bg='#002447', fg="black",font=("Poppins", 14,"bold") ,cursor = "hand2",command=lambda:choose(seat_text1,bus_button),height=3, width=30,borderwidth=0)
...
bus6_button=Label(second_button,text="rs:1500", bg='#002447', fg="white",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0)
...
bus4_button=Button(second_button,text="Legend Gorkha ", bg='#002447', fg="black",font=("Poppins", 14,"bold") ,cursor = "hand2",command=lambda:choose(seat_text2,bus4_button),height=3, width=30,borderwidth=0)
...
bus9_button=Label(third_button,text="rs.1500", bg='#002447', fg="white",font=("Poppins", 14,"bold") ,height=3, width=30,borderwidth=0)
...
bus7_button=Button(third_button,text="Nepal travels ", bg='#EE6C4D', fg="black",font=("Poppins", 14,"bold"),cursor = "hand2",command=lambda:choose(seat_text1,bus7_button),height=3, width=30,borderwidth=0)
