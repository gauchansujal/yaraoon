...
def temp_3rdtext(e):
    khalit_payment_entry.config(state="normal")  # Allow modifications
    khalit_payment_entry.delete(1.0, "end-1c")
    khalit_payment_entry.insert(1.0, "1500")
    khalit_payment_entry.config(state="disabled")  # Disable further modifications
...
khalit_payment_entry.insert(1.0, "1500")
khalit_payment_entry.config(state="disabled")  # Set the initial state to disabled
