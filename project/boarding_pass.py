...
#name
with open("selected_name.txt", "r") as file:
    selected_name = file.read()
Name=Label(detail_label,text="Name:",bg='white', font=("Poppins", 14,"bold")).grid(row=1, column=1)
Name_message=Message(detail_label,text=f"{selected_name}", font=("Poppins", 14,"bold",'underline'), background="white",fg="black",width=500).grid(row=1, column=2)

#seatno.
with open("sel_seat.txt", "r") as file:
    selected_seat = file.read()
seatno=Label(detail_label,text="seat no:",bg='white', font=("Poppins", 14,"bold")).grid(row=2, column=1)
seatmo_message=Message(detail_label,text=f"{selected_seat}", font=("Poppins", 14,"bold",'underline'), background="white",fg="black",width=500).grid(row=2, column=2)

#destination
with open("destination.txt", "r") as file:
    selected_dest = file.read()
Destination=Label(detail_label,text="Destination:",bg='white', font=("Poppins", 14,"bold")).grid(row=4, column=1)
Destination_message=Message(detail_label,text=f"{selected_dest}", font=("Poppins", 14,"bold",'underline'), background="white",fg="black",width=500).grid(row=4, column=2)
...
Date_message=Message(detail_label,text=f"{selected_date}", font=("Poppins", 14,"bold",'underline'), background="white",fg="black",width=500).grid(row=5, column=2)

#number
with open("selected_num.txt", "r") as file:
    selected_user = file.read()
Phone=Label(detail_label,text="Phone:",bg='white', font=("Poppins", 14,"bold")).grid(row=1, column=4)
Phone_message=Message(detail_label,text=f"{selected_user}", font=("Poppins", 14,"bold",'underline'), background="white",fg="black",width=500).grid(row=1, column=5)


price=Label(detail_label,text="price:",bg='white', font=("Poppins", 14,"bold")).grid(row=2, column=4)
price_message=Message(detail_label,text="1500", font=("Poppins", 14,"bold",'underline'), background="white",fg="black",width=500).grid(row=2, column=5)
