...
def temp_3rdtext(e):
    esewa_payment_entry.config(state="normal")  # Allow modifications
    esewa_payment_entry.delete(1.0, "end-1c")
    esewa_payment_entry.insert(1.0, "1500")
    esewa_payment_entry.config(state="disabled")  # Disable further modifications
...
esewa_payment_entry.insert(1.0, "1500")
esewa_payment_entry.config(state="disabled")  # Set the initial state to disabled
