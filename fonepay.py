...
def boarding_pass():
    phone_number = fonepay_entry.get("1.0", "end-1c")
    password = fonepay_password_entry.get("1.0", "end-1c")
    payment_value_str = fonepay_payment_entry.get("1.0", "end-1c")
...
def temp_3rdtext(e):
    fonepay_payment_entry.config(state="normal")  # Allow modifications
    fonepay_payment_entry.delete(1.0, "end-1c")
    fonepay_payment_entry.insert(1.0, "1500")
    fonepay_payment_entry.config(state="disabled")  # Disable further modifications
...
fonepay_payment_entry.insert(1.0, "1500")
fonepay_payment_entry.config(state="disabled")  # Set the initial state to disabled
