...
if __name__ == "__main__":
    ...
    class StarRating(tk.Frame):
        ...
        def create_widgets(self):
            heading_label = tk.Label(self, text="Give Rating", font=("Arial", 20), bg="#53D3D1")
            heading_label.grid(row=0, column=0, columnspan=self.num_stars, pady=(10, 20))

            self.stars = []
            for i in range(1, self.num_stars + 1):
                star_button = tk.Button(self, text="★", font=("Arial", 30),
            ...
            submit_button = tk.Button(self, text="Submit", command=self.submit_rating, height=3, width=10,
